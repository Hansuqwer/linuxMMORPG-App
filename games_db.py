...
GAMES_DATABASE = {
    ...
    "wow-turtle": {
        ...
        "client_download_url": "https://cdn.turtle-wow.org/client/turtle-wow-1-17-2-client-win.7z",
        "install_type": "manual_download",
        "dependencies": ["umu-launcher", "wine-staging", "p7zip"],
        "executable": "WoW.exe",
        "install_notes": "Client auto-downloads and extracts. Includes custom content patches. Linux compatible via Wine/Proton.",
        "native": False,
        "tested": True
    },
    ...
    "everquest-p1999-green": {
        ...
        "client_download_url": "https://archive.org/download/EverQuestTitanium/EverQuest_Titanium_Edition.7z",
        "install_type": "manual_download",
        "dependencies": ["umu-launcher", "wine", "d3dx9_43", "corefonts", "p7zip"],
        "executable": "eqgame.exe",
        "install_notes": "Titanium client auto-downloads from Internet Archive. Apply P99 patches after install. Use p99-login-middlemand for Linux. Windowed Mode required, disable Vertex Shaders.",
        "native": False,
        "tested": True
    },
    ...
    "everquest-p1999-blue": {
        ...
        "dependencies": ["umu-launcher", "wine", "d3dx9_43", "corefonts", "p7zip"],
        "executable": "eqgame.exe",
        "install_notes": "Same installation as Green server. Titanium client auto-downloads. Apply P99 patches after install. Long load times (5-20 min) normal.",
        "native": False,
        "tested": True
    },
    ...
    "everquest-p1999-red": {
        ...
        "dependencies": ["umu-launcher", "wine", "d3dx9_43", "corefonts", "p7zip"],
        "executable": "eqgame.exe",
        "install_notes": "Same installation as other P99 servers. Titanium client auto-downloads. Smaller but dedicated PvP community.",
        "native": False,
        "tested": True
    },
