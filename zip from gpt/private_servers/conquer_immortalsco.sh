#!/usr/bin/env bash
set -euo pipefail
# UMU launcher for Conquer Online - Immortalsco
# NOTE: Provide your own game files/client. Update EXE path below.

PREFIX="$HOME/Games/umu/conquer_online/immortalsco"
EXE="$HOME/Games/Conquer/ImmortalsCO/Conquer.exe"
