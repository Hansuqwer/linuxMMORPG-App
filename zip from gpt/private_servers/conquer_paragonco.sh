#!/usr/bin/env bash
set -euo pipefail
# UMU launcher for Conquer Online - Paragonco
# NOTE: Provide your own game files/client. Update EXE path below.

PREFIX="$HOME/Games/umu/conquer_online/paragonco"
EXE="$HOME/Games/Conquer/ParagonCO/Conquer.exe"
